...
var require_tmp = __commonJS({
  "node_modules/tmp/lib/tmp.js"(exports, module2) {
    ...
    var FN_RIMRAF_SYNC = rimraf2.sync;
    ...
    function _prepareTmpDirRemoveCallback(name, opts, sync) {
      const removeFunction = opts.unsafeCleanup ? rimraf2 : fs7.rmdir.bind(fs7);
...
// package.json
var djlintVersion = "0.7.4";
var djhtmlVersion = "1.5.0";
...
var import_child_process3 = __toESM(require("child_process"));
...
var import_child_process4 = __toESM(require("child_process"));
...
var import_child_process5 = __toESM(require("child_process"));
...
async function activate(context) {
  ...
  context.subscriptions.push(import_coc10.commands.registerCommand("htmldjango.showOutput", () => {
    if (outputChannel) {
      outputChannel.show();
    }
  }));
  subscriptions.push(import_coc10.commands.registerCommand("htmldjango.builtin.installTools", async () => {
    ...
    import_coc10.workspace.nvim.command(`CocRestart`, true);
  }));
  let djhtmlPath = extensionConfig.get("djhtml.commandPath", "");
  djhtmlPath = resolveDjhtmlPath(context, djhtmlPath);
  let djlintPath = extensionConfig.get("djlint.commandPath", "");
